...
export default function Trends() {
  ...
  const [trends, setTrends] = useState({}); // name -> points, for sparklines
      ...
      <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 16, alignItems: "start" }}>
        <div className="card">
          <div style={{ padding: 12 }}>
            <input placeholder="Search analytes…" value={search} onChange={(e) => setSearch(e.target.value)} />
          </div>
              ...
              <div className="page-header" style={{ marginBottom: 8 }}>
                <div>
                  ...
                  <div className="page-subtitle">
                    {selectedTrend.points.length} test{selectedTrend.points.length === 1 ? "" : "s"} over time
                  </div>
                </div>
              </div>
